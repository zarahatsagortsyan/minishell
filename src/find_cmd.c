...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/02 18:40:48 by salaverd          #+#    #+#             */
/*   Updated: 2022/07/02 18:40:49 by salaverd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/minishell.h"

static char	**find_and_split(t_env *env_lst)
{
	char	**path;
...
static char	*find_path(t_env *env_lst, char *command)
{
	char	**path;
	char	*value;
	int		i;
