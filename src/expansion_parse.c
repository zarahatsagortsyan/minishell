...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/02 18:40:17 by salaverd          #+#    #+#             */
/*   Updated: 2022/07/02 18:40:22 by salaverd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/minishell.h"

static int	my_replace(t_token *tokens, int i, int j, t_env *env_lst)
{
	char	*new_value;
	char	*new_blank;
	char	*new_str;
...
static int	not_found_2(t_token *tokens, int *i, int j, t_env *tmp)
{
