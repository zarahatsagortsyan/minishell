...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/02 18:38:55 by salaverd          #+#    #+#             */
/*   Updated: 2022/07/02 18:38:58 by salaverd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/minishell.h"

static void	waiting(t_env **env_lst)
{
	int			exit_status;
	int			status_code;
...
static void	parent(t_command **command, t_env **env_lst)
{
	t_command	*tmp;
...
static void	exec_in_proc(t_command **command, t_env **env_lst)
{
	int			my_pid;
	t_command	*tmp;
	t_command	*tmp2;
